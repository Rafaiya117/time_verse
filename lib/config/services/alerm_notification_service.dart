...
class NotificationService {
  static final FlutterLocalNotificationsPlugin _notifications = FlutterLocalNotificationsPlugin();
  // Changed ID suffix to 'v2' so Android updates channel sound settings automatically
  static const String _channelId = 'event_reminder_channel_v2';
  ...
  static Future<void> init() async {
    ...
    const AndroidNotificationChannel channel = AndroidNotificationChannel(
      _channelId,
      'Event Reminders',
      description: 'Event notifications with alarm sound',
      importance: Importance.max,
      playSound: true,
      enableVibration: true,
    );
    ...
    await _notifications.zonedSchedule(
      ...
      NotificationDetails(
        android: AndroidNotificationDetails(
          _channelId,
          'Event Reminders',
          channelDescription: 'Event notifications with alarm sound',
          importance: Importance.max,
          priority: Priority.max,
          playSound: true,
          fullScreenIntent: true,
