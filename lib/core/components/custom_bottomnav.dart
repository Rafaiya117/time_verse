            ...
            children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  behavior: HitTestBehavior.opaque,
                  onTap: () {
                    debugPrint('SUCCESS: Tapped floating action button (Pushing Add Page)');
                    
                    // 🛠️ FIX: Do NOT call controller.navigateTo(addIndex) here.
                    // Pushing directly to GoRouter opens it as a standalone page over the entire bottom nav stack.
                    context.push('/add');
                  },
                  child: Container(
                    width: 58.w,
