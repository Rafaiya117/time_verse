                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          // Remove RepaintBoundary from wrapping the parent Container
Container(
                            width: 327.w,
                                ...
                                builder: (context, eventController, _) {
                                  return Column(
                                    ...
                                    children: [
                                      ...
                                      // 2. Event Title Text
                                      Text(
                                        eventController.eventDetail?.title ??
                                            'Traveling to grandmother',
                                      ...
                                      // 5. Quote Description Text Area (Wrapped with RepaintBoundary here)
                                      Column(
                                        mainAxisAlignment:
                                            MainAxisAlignment.center,
                                        children: [
                                          Padding(
                                            ...
                                            // 🛠️ WRAP ONLY THE TARGET TEXT WITH REPAINTBOUNDARY
                                            child: RepaintBoundary(
                                              key:
                                                  eventController.quoteShareKey,
                                              child: Container(
                                                color: isDarkMode
                                                    ? Colors.transparent
                                                    : Colors
                                                          .white, // Ensures correct background canvas color
                                                child: Text(
